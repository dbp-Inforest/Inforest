...
public class DispatcherServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) 
    	...
    	System.out.println("Dispatcher : " + request.getMethod());
    	System.out.println("Dispatcher : " + request.getRequestURI());
    	System.out.println("Dispatcher : " + request.getServletPath());
