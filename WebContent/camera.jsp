...
function search(kind, targetUri) {
   if (form.cameraSearch.value == "") {
         alert("검색어를 입력해주세요");
         form.cameraSearch.focus();
         return false;
   } 
   ...
   <!-- search form -->
	...
	<input type="hidden" name="kind2" value="10"/>
	   <div class="flex-w flex-m m-r-20 m-tb-5">
	       <input class="stext-104 cl2 plh4 size-search bor13 p-lr-20 m-r-10 m-tb-5" type="text" name="cameraSearch" placeholder="Please write down the search term.">
	      <div class="flex-c-m stext-101 cl2 size-118 bg8 bor13 hov-btn3 p-lr-15 trans-04 pointer m-tb-5">
	      <button type="button"  onClick="search(2, '<c:url value='/productSearch'/>')">Search</button>
	      </div>
	   </div>
	</form> 


   <form name="pform" class="bg0 p-t-30 p-b-85" style="position:absolute;left:50%;margin:0 0 0 -510px;">
            ...
            <div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50" style="display:inline;float:left;width:1050px">
               <div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm" style="font-size:20px">
                  ...
                  <td class="column-0" style="padding-left:30px">
                       ...
                       <td class="column-2" style="padding-left:85px"><c:out value="${camera.brand}"/></td>   
                       <td class="column-3" style="padding-left:70px"><c:out value="${camera.price}"/></td>
                       <td class="column-4 btn-addwish-b2" style="padding-left:90px">
                             <a href="#" onClick="like( '${camera.productId}', ${status.index}, '<c:url value='/productLike'/>' )">
                             <c:set var="a" value="${camera.productId}"/>
